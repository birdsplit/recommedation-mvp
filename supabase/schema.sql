...
create table products (
  ...
  assembly_people int not null default 1,    -- 권장 조립 인원
  assembly_tools text,                       -- 예: '육각렌치 동봉', '전동드릴 권장'
  disassembly_ease text
    check (disassembly_ease in ('easy','medium','hard')),
  review_risks text[] not null default '{}', -- constants.ts REVIEW_RISKS 슬러그 10종
